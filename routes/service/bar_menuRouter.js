...
router.post('/bar_menu',authMiddleware, async (req, res) => {
  ...
  router.get('/bar_menu', authMiddleware, async (req, res) => {
    try {
  ...
  router.get('/bar_menu/:id', authMiddleware, async (req, res) => {
    try {
  ...
  router.patch('/bar_menu/:id', authMiddleware, async (req, res) => {
  ...
  router.delete('/bar_menu/:id', authMiddleware, async (req, res) => {
    try {
